...
const Profile_basic_detail = () =>
{
  ...
  return (
    <div className="flex flex-col lg:flex-row h-full bg-black border-1 border-transparent gap-2 px-4 py-6">

      <div className="relative w-full lg:w-[20%] mx-auto lg:mx-6 mb-4 lg:mb-0">
        <div className=" absolute top-[-20%] w-[80%] bg-white flex justify-center items-center rounded-full overflow-hidden">
